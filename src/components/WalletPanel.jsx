...
export default function WalletPanel() {
  ...
  return (
    <div
      className="fixed inset-0 z-[70] flex items-center justify-center px-4 modal-overlay"
      onClick={() => setOpen(false)}
    >
      <div className="absolute inset-0 bg-black/75 backdrop-blur-md" />

      <div
        className="relative max-w-md w-full modal-panel"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Panel */}
        <div className="glass-strong rounded-2xl border border-white/10 overflow-hidden max-h-[90vh] overflow-y-auto">
          {/* Top accent */}
